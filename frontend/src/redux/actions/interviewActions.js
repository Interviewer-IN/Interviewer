...
export function showInterviewsForInterviewer(userID, idExpandedElement = false) {
    return (dispatch) => new Promise((resolve) => {
        fetch("/api/v1/interviews?user_id=" + userID,
            {
                method: 'get',
                headers: {
                    "Content-Type": "application/json",
...
export function getInterviewForInterviewer(userID, id) {
    return (dispatch) => new Promise(function(resolve, reject) {
        fetch("/api/v1/interviews/" + id + "?user_id=" + userID)
            .then(function(response) {
                return response.text();
            })
            .then(function(interview) {
...
export function removeInterviewForInterviewer(userID, id) {
    return (dispatch) => {
        fetch("/api/v1/interviews/" + id + "?user_id=" + userID,
            {
                method: 'delete',
...
export function updateInterviewForUser(userID, date, message) {
    let successMessage = message || 'Interview was updated';
    return (dispatch) => {
        fetch('/api/v1/interviews/' + date.id + "?user_id=" + userID,
            {
                method: 'put',
                body: JSON.stringify(date),
                headers: {
